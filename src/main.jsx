...
function App(){
 ...
 return <>
 <div className="wrap">
  <header className="top"><div className="top-row"><div className="top-copy"><div className="eyebrow-row"><span className="dot"/> NR Conexões — infraestrutura EPON / GPON</div><h1>Busca de nodes</h1><div className="sub">Digite um node, VLAN, OLT ou bairro para encontrar a linha correspondente, com todos os dados daquele ponto.</div></div><img className="brand-logo" src="/logo-branco.png" alt="NR Conexões"/></div></header>
